...
const SLIDES = [
  ...
  },
  {
    ...
    description:
      "Start a timer, stay distraction-free, and watch your village come to life with every completed session.",
  ...
  },
  {
    ...
    description:
      "Each focus session adds new display to your village. More focus = more upgrades.",
  ...
  },
  {
    ...
    description:
      "Begin your first focus session and start building your world.",
